...
ui <- fluidPage(theme = shinytheme("superhero"),
  ...
  titlePanel("Previsao de Qualidade de Veiculos"),
  fluidRow(
    column(4,
           selectInput("buying","Preco:",choices = buying)
    ),
    column(4,
           selectInput("maint","Manutencao:",choices = maint)
    ),
    column(4,
  ...
  fluidRow(
    ...
    column(4,
           selectInput("safety","Seguranca:",choices = safety)  
     )
  ),
  fluidRow(
    column(12,
